...
from pitchplease.models.RMVPE.constants import N_MELS

# Adapted from https://github.com/Dream-High/RMVPE/blob/main/src/deepunet.py
# DeepUnet
...
# Adapted from https://github.com/Dream-High/RMVPE/blob/main/src/seq.py
# Sequence models
