...
# TODO: remove depandancy on local_attention if possible
from torch import nn

# Adapted from https://github.com/CNChTu/FCPE/blob/main/torchfcpe/model_convnext.py
# ConvNeXtBlock
...
# Adapted from https://github.com/CNChTu/FCPE/blob/7f714c036c448fe8cdc9b0a59a99b2f3c7f8a907/torchfcpe/model_conformer_naive.py#L15
...
class CFNEncoderLayer(nn.Module):
    ...
    def __init__(
        ...
        if conv_dropout > 0.0:
            self.conformer = nn.Sequential(ConformerConvModule(dim_model), nn.Dropout(conv_dropout))
        else:
